...
path = sys.argv[2]
# num = 10000
# path = "selectivity_new_uniform_distribution_10000.loc"
epsilon = 0.01
selectivity_x = np.random.uniform(low=0+epsilon, high=100-epsilon, size=num)
selectivity_y = np.random.uniform(low=0+epsilon, high=100-epsilon, size=num)
